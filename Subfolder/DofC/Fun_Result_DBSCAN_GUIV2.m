function Fun_Result_DBSCAN_GUIV2(ClusterSmoothTableCh1A)
%% Comparison of density 

%% Density Comparison
           [row, column]=size(ClusterSmoothTableCh1A);
...
%% Convert to excel file
    ...
    xlswrite('DofC_DBSCAN',Array,RegionName,'A1');
    xlswrite('DofC_DBSCAN',Matrix_Result,RegionName,'A2');
