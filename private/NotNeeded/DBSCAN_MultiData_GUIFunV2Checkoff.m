function [ClusterSmoothTable,Result]=DBSCAN_MultiData_GUIFunV2Checkoff(AllData)
...
%              
     ...
     Result = cell(size(AllData, 1), size(AllData, 2));
     ClusterSmoothTable = cell(size(AllData, 1), size(AllData, 2));
