function [ClusterSmoothTableCh1, ClusterSmoothTableCh2]=Fun_DBSCAN_DoC_GUIV2(ROIData, Data_DegColoc, Path_name, Chan1Color, Chan2Color)
         ...
         for q=1:size(ROIData,1) % index for the region
             ...
             Data_DoC=Data_DegColoc{q,p};
                ...
                % threads = 2
                        ...
                        [~, ClusterCh, ~, fig] = DBSCANHandler([Data_DoC1.X Data_DoC1.Y], ...
